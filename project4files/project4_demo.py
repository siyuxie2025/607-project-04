...
This script provides an interactive demonstration of the multi-algorithm
quantile bandit comparison framework.

Usage:
    python PROJECT4_DEMO.py                 # Interactive mode
    python PROJECT4_DEMO.py --quick         # Quick demo
    python PROJECT4_DEMO.py --scenario NAME # Specific scenario
"""
